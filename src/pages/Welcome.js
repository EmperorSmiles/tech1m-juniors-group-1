  ...
  return (
    ...
    >
      <div className="bg-dblue-900 bg-opacity-70 h-full flex flex-col  md:flex-row items-center content-between md:justify-between px-10 md:px-20" >
        ...
        >
          <img src={logo} alt="background" className="h-10 w-20 md:w-full md:h-full" />
        </div>
        <div
          className="flex my-2 md:my-0 w-80 md:w-1/2 flex-col bg-primary-200 bg-opacity-30 h-full justify-center md:px-10 space-y-4 "
        >
